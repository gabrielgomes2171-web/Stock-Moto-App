...
const pecas = [
  {
    nome: "Bau Pro Tork 80 Litros (Plástico)",
    valor: "R$ 180,00",
    estoque: "2 Un",
    status: "OK",
  },
  {
    nome: "Baú 90 Litros MG (Plástico)",
    valor: "R$ 250,00",
    estoque: "2 Un",
    status: "OK",
  },
...
export default function Baus() {
  const router = useRouter();

  return (
    <View style={styles.container}>
      <Header title="Baús" showSettings />
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <Text style={styles.title}>BAÚS</Text>
